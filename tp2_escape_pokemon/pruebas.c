...
void pruebas_objetos_conocidos()
{
	int cantidad = 0;
	...
	pa2m_afirmar(objetos2 != NULL,
		     "Puedo pedir el vector de nombres a la sala pasando cantidad no NULL");
	pa2m_afirmar(cantidad == 1, "Al inicial el juego solo conozco el primer elemento");
...
void pruebas_objetos_poseidos()
{
	...
	pa2m_afirmar(objetos2 != NULL,
		     "Puedo pedir el vector de nombres a la sala pasando cantidad no NULL");
	pa2m_afirmar(cantidad == 0, "Al iniciar el juego no se poseen objetos");
...
int main()
{
	...
	pa2m_nuevo_grupo("Pruebas de vector de objetos conocidos");
	pruebas_objetos_conocidos();

	pa2m_nuevo_grupo("Pruebas de vector de objetos poseidos");
	pruebas_objetos_poseidos();	
